...
> 4. Рекомендую запускать **service_all.bat**, который разблокирует доступ к YouTube, Discord и автоматически будет добавлять недоступные хосты в список + автозапуск при старте системы
